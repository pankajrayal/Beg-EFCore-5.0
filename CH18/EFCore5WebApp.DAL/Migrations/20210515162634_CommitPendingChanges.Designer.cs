...
namespace EFCore5WebApp.DAL.Migrations
{
    ...
    [Migration("20210515162634_CommitPendingChanges")]
    partial class CommitPendingChanges
    {
            ...
            modelBuilder.Entity("EFCore5WebApp.Core.Entities.Person", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Age = 20,
                            CreatedOn = new DateTime(2021, 5, 15, 21, 56, 33, 624, DateTimeKind.Local).AddTicks(8966),
                        ...
                        new
                        {
                            Id = 2,
                            Age = 30,
                            CreatedOn = new DateTime(2021, 5, 15, 21, 56, 33, 625, DateTimeKind.Local).AddTicks(6714),
                            EmailAddress = "john@smith.com",
                            FirstName = "Susan",
                            LastName = "Jones"
                        });
