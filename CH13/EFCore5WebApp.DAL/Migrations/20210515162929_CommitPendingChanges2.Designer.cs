...
namespace EFCore5WebApp.DAL.Migrations
{
    ...
    [Migration("20210515162929_CommitPendingChanges2")]
    partial class CommitPendingChanges2
    {
            ...
            modelBuilder.Entity("EFCore5WebApp.Core.Entities.Person", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Age = 20,
                            CreatedOn = new DateTime(2021, 5, 15, 21, 59, 29, 267, DateTimeKind.Local).AddTicks(8629),
                        ...
                        new
                        {
                            Id = 2,
                            Age = 30,
                            CreatedOn = new DateTime(2021, 5, 15, 21, 59, 29, 268, DateTimeKind.Local).AddTicks(5563),
                            EmailAddress = "john@smith.com",
                            FirstName = "Susan",
                            LastName = "Jones"
                        });
