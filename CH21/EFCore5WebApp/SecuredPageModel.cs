...
namespace EFCore5WebApp {
    public class SecuredPageModel: PageModel, IAsyncPageFilter {
        ...
        public SecuredPageModel(AppDbContext context, SignInManager<IdentityUser> signInManager,
        ...
        public override async Task OnPageHandlerExecutionAsync(PageHandlerExecutingContext context, 
            ...
            IsViewOnlyUser = isSignedIn && await _userManager.IsInRoleAsync(user, 
                Roles.ViewOnlyRoleName);
            await next.Invoke();
        }
    }
}