...
namespace EFCore5WebApp {
    ...
    public class Program {
        ...
        private static async Task CreateRoleIfNotExists(RoleManager<IdentityRole> roleManager, 
            string roleName) {
        ...
        private static async Task AssignRoleToUser(UserManager<IdentityUser> userManager, 
        ...
        private static async Task AddAppRoles(IServiceProvider serviceProvider) {
            ...
            await AssignRoleToUser(userManager, viewOnlyUserEmail, viewOnlyRoleName)
